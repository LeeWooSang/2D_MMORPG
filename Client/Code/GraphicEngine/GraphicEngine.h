...
public:
	...
	void RenderRectangle(const D2D1_RECT_F& pos, const std::string& color = "»¡°£»ö");
	void RenderFillRectangle(const D2D1_RECT_F& pos, const std::string& color = "»¡°£»ö");
	...
	void RenderText(const std::wstring& text, int x, int y, const std::string& color);
